  ...
  <div class="content-wrapper bg-custom1">
    <div class="content-header bg-custom1">
      <div class="container-fluid text-white">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">View Egg Readings</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">View Egg Readings</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <table id="example1" class="table table-striped table-hover">
                ...
                <?php
                  ...
                  while($row_data = mysqli_fetch_array($query)){
                    ...
                    for($i = 0; $i < $count-1; $i++){
                        $sql2 = "SELECT DATEDIFF(expiration_date, NOW()) FROM egg_reading_t WHERE reading_id = {$row_data['reading_id']}";
                        ...
                        if($row_data2[0] > 0){
                            echo "<td style='color: green'>Fresh</td>";
                        }
                        else{
