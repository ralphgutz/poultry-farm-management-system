        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false"><br>
          ...
          <li class='nav-item'>
            ...
            <li class='nav-item active-item'>
              <a href='view-sales.php' class='nav-link active'>
        ...
        <div class="col">
          <div class="card bg-custom text-white">
            <div class="card-header bg-custom2 border-0">
              ...
              <button class='btn btn-warning float-right'><a href="view-customer.php" class="text-dark">View Customer List</a> </button>
            </div>
            <div class="card-body">
              <table id="example1" class="table table-striped table-hover">
                ...
                <?php
                  ...
                  while($row_data = mysqli_fetch_array($query)){
                    ...
                    for($i = 0; $i < $count-1; $i++){
                        echo "
                        <td>{$row_data['invoice_id']}</td>
                        <td>{$row_data['invoice_date']}</td>
                        <td>{$row_data['customer_id']}</td>
                        <td>{$row_data['payment_date']}</td>
                        <td>{$row_data['type']}</td>
                        <td>{$row_data['item']}</td>
                        <td>{$row_data['item_sold']}</td>
