...
<div class="wrapper">
  <nav class="main-header navbar navbar-expand navbar navbar-dark bg-custom">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link font-weight-bold">USER ACTIVITY</a>
      </li>
    </ul>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class='nav-item'>
            ...
            <li class='nav-item active-item'>
              <a href='user-activity.php' class='nav-link active'>
  ...
  <div class="content-wrapper bg-custom1">
    <div class="content-header bg-custom1">
      <div class="container-fluid text-white">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">View User Activities</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">View User Activities</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <table id="example1" class="table table-striped table-hover">
                ...
                <?php
                  ...
                  while($row_data = mysqli_fetch_array($query)){
                    ...
                    for($i = 0; $i < $count-1; $i++){
                        echo "
                            <td>{$row_data['act_id']}</td>
                            <td>{$row_data['emp_id']}</td>
                            <td>{$row_data['activity']}</td>
                            <td>{$row_data['act_datetime']}</td>
                        ";
                    }
